...
Public Class Banco
    ...
    Private Shared _TipoUsuario As Integer = 0
    ...
    Public Shared Function ObterImagemEmpresa() As Object
        ...
        Try
            ...
            Result = LerCampoBLOB("SELECT IMAGEM FROM " & Banco.BancoNVOCC & "TB_EMPRESAS WHERE AUTONUM = " & Banco.Empresa)
    ...
    Public Shared Function ConnectionString() As String
        Return String.Format("Data Source={0};Initial Catalog={1};User ID={2};Password={3};", Servidor, Base, Usuario, Senha)
    End Function
