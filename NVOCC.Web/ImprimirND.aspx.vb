Public Class ImprimirND
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Request.QueryString("id") <> "" Then
            ...
            Dim ds As DataSet = Con.ExecutarQuery("SELECT A.ID_CONTA_PAGAR_RECEBER,B.ID_PARCEIRO_EMPRESA,CONVERT(VARCHAR,A.DT_VENCIMENTO,103)DT_VENCIMENTO,NR_FATURA_FORNECEDOR,
...
GROUP BY A.ID_CONTA_PAGAR_RECEBER,B.ID_PARCEIRO_EMPRESA,A.DT_VENCIMENTO,NR_FATURA_FORNECEDOR,ID_PORTO_ORIGEM,ID_PORTO_DESTINO,DT_EMBARQUE,DT_CHEGADA,ID_NAVIO,NR_BL, VL_PESO_BRUTO,VL_M3,QT_MERCADORIA,D.ID_BL,D.ID_BL_MASTER")
