...
FROM            dbo.TB_CABECALHO_COMISSAO_VENDEDOR AS A LEFT OUTER JOIN
    ...
    Private Sub btnGravaTaxaTabela_Click(sender As Object, e As EventArgs) Handles btnGravaTaxaTabela.Click
        ...
        If txtIDTabelaTaxa.Text = "" Then
            Con.ExecutarQuery("INSERT INTO TB_INSIDE_TAXA_COMISSAO (DT_VALIDADE_INICIAL,VL_TAXA_LCL,VL_TAXA_FCL) VALUES (CONVERT(DATE,'" & txtValidade.Text & "',103)," & txtLCL.Text & ", " & txtFCL.Text & ") ")
            divInfo.Visible = True
        ...
        Else
            Con.ExecutarQuery("UPDATE TB_INSIDE_TAXA_COMISSAO SET DT_VALIDADE_INICIAL = CONVERT(DATE,'" & txtValidade.Text & "',103),VL_TAXA_LCL = " & txtLCL.Text & ",VL_TAXA_FCL = " & txtFCL.Text & "  WHERE ID_INSIDE_TAXA = " & txtIDTabelaTaxa.Text)
            divInfo.Visible = True
