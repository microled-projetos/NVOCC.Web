...
Partial Public Class MoedaFreteArmador
    ...
    '''<summary>
    '''Controle txtIDMoedaFreteArmador.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Modificar a declaração do campo de movimento do arquivo de designer para o arquivo code-behind.
    '''</remarks>
    Protected WithEvents txtIDMoedaFreteArmador As Global.System.Web.UI.WebControls.TextBox
    ...
    '''Modificar a declaração do campo de movimento do arquivo de designer para o arquivo code-behind.
    '''</remarks>
    Protected WithEvents ddlArmador As Global.System.Web.UI.WebControls.DropDownList
    ...
    '''Modificar a declaração do campo de movimento do arquivo de designer para o arquivo code-behind.
    '''</remarks>
    Protected WithEvents dsArmador As Global.System.Web.UI.WebControls.SqlDataSource
End Class
