Public Class ConsultaParceiro
    ...
    Private Sub dgvParceiros_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles dgvParceiros.RowCommand
        ...
        ElseIf e.CommandName = "Taxas" Then
            ...
            Dim ds As DataSet = Con.ExecutarQuery("SELECT ISNULL(FL_PRESTADOR,0)FL_PRESTADOR, ISNULL(FL_AGENTE_INTERNACIONAL,0)FL_AGENTE_INTERNACIONAL,ISNULL(FL_TRANSPORTADOR,0)FL_TRANSPORTADOR, ISNULL(FL_CIA_AEREA,0)FL_CIA_AEREA FROM [TB_PARCEIRO] WHERE ID_PARCEIRO = " & ID)
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                ElseIf ds.Tables(0).Rows(0).Item("FL_TRANSPORTADOR") = True Then

                    ScriptManager.RegisterStartupScript(Page, Page.GetType(), "script", "<script>alert('Parceiro selecionado é TRANSPORTADOR!');</script>", False)

                ElseIf ds.Tables(0).Rows(0).Item("FL_CIA_AEREA") = True Then

                    ScriptManager.RegisterStartupScript(Page, Page.GetType(), "script", "<script>alert('Parceiro selecionado é CIA AEREA!');</script>", False)
