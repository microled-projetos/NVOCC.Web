...
Public Class OUTLOOK
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim ds As DataSet = Con.ExecutarQuery("select EMAIL_CONTATO,NM_CONTATO from TB_CONTATO where ID_CONTATO = (select ID_CONTATO from TB_COTACAO where ID_COTACAO = " & ID_COTACAO & ")")
        If ds.Tables(0).Rows.Count > 0 Then
            Dim app As Application = New Application()
            Dim mail As MailItem = CType(app.CreateItem(OlItemType.olMailItem), MailItem)
            mail.[To] = ds.Tables(0).Rows(0).Item("EMAIL_CONTATO").ToString() '"contatodocliente@gmail.com"
            mail.Subject = "COTAÇÃO"
            mail.Body = "Prezado, " & ds.Tables(0).Rows(0).Item("NM_CONTATO").ToString() & " <br/> Segue sua proposta visando uma oportunidade de embarque."
