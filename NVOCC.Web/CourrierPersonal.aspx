<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CourrierPersonal.aspx.cs" Inherits="ABAINFRA.Web.CourrierPersonal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Scripts" runat="server">
    <script>
            ...
            $.ajax({
                ...
                success: function (dado) {
                    ...
                    if (data != "erro") {
                        ...
                        document.getElementById('nrprocesso').disabled = true;
                        document.getElementById('nmcliente').disabled = true;
                        document.getElementById('idmbl').disabled = true;
                        document.getElementById('idhbl').disabled = true;
                        document.getElementById('dtRecebimentoMBL').disabled = true;
                        document.getElementById('cdRastreamentoMBL').disabled = true;
                        document.getElementById('dtRecebimentoHBL').disabled = true;
                        document.getElementById('cdRastreamentoHBL').disabled = true;
                        document.getElementById('nrFatura').disabled = true;
                        ...
                        if (data.FL_TROCA == "True") {
                            ...
                            document.getElementById('checkTroca').disabled = true;
                        } else {
                        ...
                        if (data.CD_RASTREAMENTO_HBL == "ORIGEM") {
                            ...
                            document.getElementById("checkDestino").disabled = true;
        ...
        $("#btnEditarCourrier").click(function () {
            ...
            $.ajax({
                type: "POST",
                url: "DemurrageService.asmx/editarCourrierPersonal",
