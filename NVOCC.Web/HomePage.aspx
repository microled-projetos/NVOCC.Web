        ...
        function HomePage() {
            $.ajax({
                ...
                success: function (dado) {
                    ...
                    dado = $.parseJSON(dado);
                    if (dado != null) {
                        result = "<iframe id='pbi' title='Embarques - Operacional' src='" + dado[0]["DS_LINK_ACESSO"] + "' frameborder='0' allowFullScreen='true' style='width: 100%; height: calc(97vh - 60px - 20px); position: absolute; left: 0;'></iframe>";
                        $("#main").append(result);
                    }
                }
            })
