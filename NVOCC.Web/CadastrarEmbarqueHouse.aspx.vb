Public Class CadastrarEmbarqueHouse
    ...
    Sub CarregaCampos()
        ...
        Dim Con As New Conexao_sql
        Con.Conectar()
        Dim ds As DataSet = Con.ExecutarQuery("SELECT ID_BL,ID_SERVICO,FL_TRAKING_AUTOMATICO,ID_BL_MASTER,ID_COTACAO,ISNULL(NR_BL,0)NR_BL,NR_PROCESSO,ID_PARCEIRO_TRANSPORTADOR,ID_PARCEIRO_CLIENTE,ID_PARCEIRO_INDICADOR ,YEAR(DT_ABERTURA)ANO_ABERTURA,
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            If Not IsDBNull(ds.Tables(0).Rows(0).Item("ID_BL")) Then
                ...
                If ds.Tables(0).Rows(0).Item("ID_SERVICO") = 1 Or ds.Tables(0).Rows(0).Item("ID_SERVICO") = 4 Then
                    ...
                    'If Not IsDBNull(ds.Tables(0).Rows(0).Item("PLACE_RECEIPT")) Then
                    '    ddlPlaceReceipt_BasicoMaritimo.SelectedValue = ds.Tables(0).Rows(0).Item("PLACE_RECEIPT")
                    'End If
                ...
                ElseIf ds.Tables(0).Rows(0).Item("ID_SERVICO") = 2 Or ds.Tables(0).Rows(0).Item("ID_SERVICO") = 5 Then
                    ...
                    'If Not IsDBNull(ds.Tables(0).Rows(0).Item("PLACE_RECEIPT")) Then
                    '    ddlPlaceReceipt_BasicoAereo.SelectedValue = ds.Tables(0).Rows(0).Item("PLACE_RECEIPT")
                    'End If
                ...
                Else
                    ...
                    Else
                        ...
                        If ds1.Tables(0).Rows(0).Item("QTD") = 0 Then
                            ...
                            txtProfitCalculado_BasicoMaritimo.Text = CalculoProfit(txtID_BasicoMaritimo.Text)
                ...
                Else
                    ...
                    Else
                        ...
                        If ds1.Tables(0).Rows(0).Item("QTD") = 0 Then
                            ...
                            txtProfitCalculado_BasicoAereo.Text = CalculoProfit(txtID_BasicoAereo.Text)
