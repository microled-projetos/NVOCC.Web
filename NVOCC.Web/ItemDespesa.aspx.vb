Public Class ItemDespesa
    ...
    Private Sub btnGravar_Click(sender As Object, e As EventArgs) Handles btnGravar.Click
        ...
        Else
            ...
            Else
                ...
                ds = Con.ExecutarQuery("SELECT FL_ATUALIZAR FROM [TB_GRUPO_PERMISSAO] where ID_Menu = 22 AND  ID_TIPO_USUARIO = " & Session("ID_TIPO_USUARIO"))
                If ds.Tables(0).Rows.Count > 0 Then
    ...
    Private Sub dgvItemDespesa_PreRender(sender As Object, e As EventArgs) Handles dgvItemDespesa.PreRender
        Dim Con As New Conexao_sql
        Con.Conectar()
        Dim ds As DataSet = Con.ExecutarQuery("SELECT FL_EXCLUIR,FL_ATUALIZAR FROM [TB_GRUPO_PERMISSAO] where ID_Menu = 22 AND  ID_TIPO_USUARIO = " & Session("ID_TIPO_USUARIO"))
        If ds.Tables(0).Rows.Count > 0 Then
