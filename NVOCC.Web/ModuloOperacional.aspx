<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ModuloOperacional.aspx.vb" Inherits="NVOCC.Web.ModuloOperacional" %>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="False">
                                <ContentTemplate>
                                    ...
                                    <div class="row linhabotao text-center">
                                        ...
                                        <asp:LinkButton ID="lkDuplicarHouse" runat="server" CssClass="btn btnn btn-default btn-sm" Style="font-size: 15px"><i class="glyphicon glyphicon-duplicate"></i>&nbsp;Duplicar</asp:LinkButton>
