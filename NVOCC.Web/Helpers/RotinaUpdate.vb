...
(SELECT SUM(ISNULL(QT_MERCADORIA,0))QT_MERCADORIA FROM TB_CARGA_BL WHERE ID_BL =  " & ID_BL & ") WHERE ID_BL =  " & ID_BL)
            ...
            ElseIf ID_TIPO_ESTUFAGEM = 2 Then
                ...
                dsProcesso = Con.ExecutarQuery("SELECT ID_MERCADORIA, ID_EMBALAGEM,SUM(QT_MERCADORIA)QT_MERCADORIA,SUM(VL_PESO_BRUTO)VL_PESO_BRUTO,SUM(VL_M3)VL_M3 FROM TB_CARGA_BL WHERE ID_BL = " & ID_BL & " group by ID_EMBALAGEM,ID_MERCADORIA")
