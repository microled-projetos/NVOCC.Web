...
'    '1
'    Sub Principal(Optional ID_CONTA_BANCARIA As String = "1")


'        Dim Con As New Conexao_sql
'        Con.Conectar()
'        Dim ds As DataSet = Con.ExecutarQuery("SELECT NM_CEDENTE,NR_BANCO,CNPJ_CPF_CEDENTE,NR_AGENCIA,DG_AGENCIA,NR_CONTA,DG_CONTA,ENDERECO_CEDENTE,CARTEIRA,CD_CEDENTE,CD_TRASMISSAO,NUMERO_END_CEDENTE, BAIRRO_END_CEDENTE, UF_END_CEDENTE, CEP_END_CEDENTE, CIDADE_END_CEDENTE, COMP_END_CEDENTE FROM TB_CONTA_BANCARIA WHERE ID_CONTA_BANCARIA = " & ID_CONTA_BANCARIA)
'        If ds.Tables(0).Rows.Count > 0 Then
'            cod_banco = ds.Tables(0).Rows(0).Item("NR_BANCO")
'        End If

'        If cod_banco = "033" Or cod_banco = "104" Or cod_banco = "001" Then
...
'        strS = String.Empty
'        strS = Right(String(3, "0") & IsDBNull(cod_banco, 0), 3)
'        strS = strS & "0000"
'        strS = strS & "0"
'        strS = strS & String(8, " ")
'        strS = strS & "2"
...
'        If cod_banco = "033" Then strS = strS & Mid("BANCO SANTANDER" & String(30, " "), 1, 30)
'        If cod_banco = "104" Then strS = strS & Mid("CAIXA" & String(30, " "), 1, 30)
'        If cod_banco = "001" Then strS = strS & Mid("BANCO DO BRASIL" & String(30, " "), 1, 30)
