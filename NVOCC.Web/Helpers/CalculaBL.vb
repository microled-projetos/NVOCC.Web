Public Class CalculaBL
    Public Function Calcular(ID_BL_TAXA As String) As String
        ...
        Con.Conectar()
        Dim ds As DataSet = Con.ExecutarQuery("SELECT B.ID_BL,A.ID_SERVICO,B.ID_BL_TAXA, isnull(B.VL_TAXA_MIN,0)VL_TAXA_MIN,isnull(B.VL_TAXA,0)VL_TAXA,B.ID_MOEDA,isnull(B.VL_CAMBIO,0)VL_CAMBIO,B.ID_BASE_CALCULO_TAXA,isnull(A.VL_M3,0)VL_M3,isnull(A.VL_PESO_BRUTO,0)VL_PESO_BRUTO,
