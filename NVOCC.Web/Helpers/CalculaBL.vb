    ...
    Function CalculoProfitBroker(ID As String) As String
        ...
        If dsProfit.Tables(0).Rows.Count > 0 Then
            ...
            ElseIf dsProfit.Tables(0).Rows(0).Item("ID_PROFIT_DIVISAO_BROKER") = 3 Or dsProfit.Tables(0).Rows(0).Item("ID_PROFIT_DIVISAO_BROKER") = 4 Then
                ...
                Dim dsAuxiliar As DataSet = Con.ExecutarQuery("SELECT ISNULL((SELECT SUM(VL_TAXA_CALCULADO) FROM TB_BL_TAXA WHERE CD_PR = 'R' AND FL_DIVISAO_PROFIT_BROOKER = 1 AND ID_BL = " & ID & ") - (SELECT SUM(VL_TAXA_CALCULADO) FROM TB_BL_TAXA WHERE CD_PR = 'P' AND FL_DIVISAO_PROFIT_BROOKER = 1 AND ID_BL = " & ID & "),0) AS LUCRO")
