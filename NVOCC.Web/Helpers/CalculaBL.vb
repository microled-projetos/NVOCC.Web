...
INNER JOIN TB_TIPO_CONTAINER C ON C.ID_TIPO_CONTAINER =A.ID_TIPO_CNTR
    ...
    End Function
    Function CalculoProfitBroker(ID As String) As String
        Try
            Dim Profit As String = ""
            Dim x As Double
            Dim y As Double
            ...
            Dim dsProfit As DataSet = Con.ExecutarQuery("Select ISNULL(ID_PROFIT_DIVISAO_BROKER,0)ID_PROFIT_DIVISAO_BROKER,ISNULL(VL_PROFIT_DIVISAO_BROKER,0)VL_PROFIT_DIVISAO_BROKER FROM TB_BL WHERE ID_BL = " & ID)

            If dsProfit.Tables(0).Rows.Count > 0 Then
                If dsProfit.Tables(0).Rows(0).Item("ID_PROFIT_DIVISAO_BROKER") = 1 Or dsProfit.Tables(0).Rows(0).Item("ID_PROFIT_DIVISAO_BROKER") = 2 Then
                    'VALOR FIXO A RECEBER
                    'VALOR FIXO A PAGAR
                    z = dsProfit.Tables(0).Rows(0).Item("VL_PROFIT_DIVISAO_BROKER")
                    Profit = z.ToString
                    Profit = Profit.Replace(".", String.Empty).Replace(",", ".")

                    Con.ExecutarQuery("UPDATE TB_BL SET VL_PROFIT_DIVISAO_CALCULADO_BROKER = '" & Profit & "'  WHERE ID_BL = " & ID)
                    Return z

                ElseIf dsProfit.Tables(0).Rows(0).Item("ID_PROFIT_DIVISAO_BROKER") = 3 Or dsProfit.Tables(0).Rows(0).Item("ID_PROFIT_DIVISAO_BROKER") = 4 Then
                    'PERCENTUAL A PAGAR
                    'PERCENTUAL A RECEBER
                    ...
                    sb.AppendLine("SELECT ISNULL((SELECT SUM(VL_TAXA_CALCULADO) FROM TB_BL_TAXA WHERE CD_PR = 'R' AND FL_DIVISAO_PROFIT_BROOKER = 1 AND ID_BL = " & ID & ") - (SELECT SUM(VL_TAXA_CALCULADO) FROM TB_BL_TAXA WHERE CD_PR = 'P' AND FL_DIVISAO_PROFIT_BROOKER = 1 AND ID_BL = " & ID & "),0) AS LUCRO")

                    Dim dsAuxiliar As DataSet = Con.ExecutarQuery(sb.ToString)



                    x = dsProfit.Tables(0).Rows(0).Item("VL_PROFIT_DIVISAO_BROKER")
                    y = dsAuxiliar.Tables(0).Rows(0).Item("LUCRO")
                    y = y / 100
                    z = y * x
                    Profit = z.ToString
                    ...
                    Con.ExecutarQuery("UPDATE TB_BL_TAXA SET FL_DIVISAO_PROFIT_BROOKER = 1 WHERE ID_ITEM_DESPESA = 14 AND ID_BL = " & ID)
                    Con.ExecutarQuery("UPDATE TB_BL SET VL_PROFIT_DIVISAO_CALCULADO_BROKER = '" & Profit & "'  WHERE ID_BL = " & ID)
                    Return z


                ElseIf dsProfit.Tables(0).Rows(0).Item("ID_PROFIT_DIVISAO_BROKER") = 5 Or dsProfit.Tables(0).Rows(0).Item("ID_PROFIT_DIVISAO_BROKER") = 6 Then
                    'POR TEU A PAGAR
                    'POR TEU A RECEBER
                    Dim dsAuxiliar As DataSet = Con.ExecutarQuery("	SELECT SUM(TEU)QTD FROM TB_CARGA_BL A  INNER JOIN TB_TIPO_CONTAINER C ON C.ID_TIPO_CONTAINER =A.ID_TIPO_CNTR  WHERE	 A.ID_BL = " & ID)
                ...
                ElseIf dsProfit.Tables(0).Rows(0).Item("ID_PROFIT_DIVISAO_BROKER") = 7 Or dsProfit.Tables(0).Rows(0).Item("ID_PROFIT_DIVISAO_BROKER") = 8 Then
                    'POR CONTEINER A RECEBER
                    'POR CONTEINER A PAGAR
                ...
                ElseIf dsProfit.Tables(0).Rows(0).Item("ID_PROFIT_DIVISAO_BROKER") = 9 Or dsProfit.Tables(0).Rows(0).Item("ID_PROFIT_DIVISAO_BROKER") = 10 Then
                    'POR W/M A PAGAR
                    'POR W/M A RECEBER
                    Dim dsAuxiliar As DataSet = Con.ExecutarQuery("SELECT ISNULL(VL_PESO_BRUTO,0)VL_PESO_BRUTO,ISNULL(VL_M3,0)VL_M3 FROM TB_BL WHERE ID_BL = " & ID)
                    ...
                    y = dsProfit.Tables(0).Rows(0).Item("VL_PROFIT_DIVISAO_BROKER")
                    ...
                    Return z
                Else
                    Con.ExecutarQuery("UPDATE TB_BL SET VL_PROFIT_DIVISAO_CALCULADO_BROKER = 0, VL_PROFIT_DIVISAO_BROKER = 0  WHERE ID_BL = " & ID)
                    Return "0"
                End If
            Else
                Con.ExecutarQuery("UPDATE TB_BL SET VL_PROFIT_DIVISAO_CALCULADO_BROKER = 0 ,VL_PROFIT_DIVISAO_BROKER = 0  WHERE ID_BL = " & ID)
