Public Class AtualizaStatusFreteAgente
    Function AtualizaStatusFreteAgente(ID_BL As Integer) As Integer
        Dim Con As New Conexao_sql
        Con.Conectar()
        Dim ds As DataSet
        ds = Con.ExecutarQuery("SELECT ISNULL(NR_PROCESSO,0)NR_PROCESSO, ISNULL(ID_SERVICO,0)ID_SERVICO, ISNULL(ID_TIPO_ESTUFAGEM,0)ID_TIPO_ESTUFAGEM, ISNULL(FL_FREE_HAND,0)FL_FREE_HAND, ISNULL(ID_TIPO_PAGAMENTO,0)ID_TIPO_PAGAMENTO FROM TB_BL WHERE ID_BL = " & ID_BL)
        If ds.Tables(0).Rows.Count > 0 Then
            ...
            If ds.Tables(0).Rows(0).Item("ID_SERVICO") = 1 Or ds.Tables(0).Rows(0).Item("ID_SERVICO") = 4 Then
                ...
                If ds.Tables(0).Rows(0).Item("ID_ESTUFAGEM") = 1 Then
                    'ESTUFAGEM FCL
                ...
                Else ds.Tables(0).Rows(0).Item("ID_ESTUFAGEM") = 2
                    'ESTUFAGEM LCL
