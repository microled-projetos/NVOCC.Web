Public Class AtualizaStatusFreteAgente
    Function AtualizaStatusFreteAgenteHouse(ID_BL As Integer, ID_TIPO_PAGAMENTO_HOUSE As Integer) As Integer
        Dim Con As New Conexao_sql
        Con.Conectar()
        Dim ds As DataSet
        ds = Con.ExecutarQuery("SELECT ISNULL(NR_PROCESSO,0)NR_PROCESSO, ISNULL(ID_SERVICO,0)ID_SERVICO, ISNULL(ID_TIPO_ESTUFAGEM,0)ID_TIPO_ESTUFAGEM, ISNULL(FL_FREE_HAND,0)FL_FREE_HAND, ISNULL(ID_TIPO_PAGAMENTO,0)ID_TIPO_PAGAMENTO, (SELECT ISNULL(ID_TIPO_PAGAMENTO,0)ID_TIPO_PAGAMENTO FROM TB_BL B WHERE B.ID_BL =A.ID_BL_MASTER)ID_TIPO_PAGAMENTO_MASTER FROM TB_BL A WHERE ID_BL = " & ID_BL)
