            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                   ...
                   <asp:Label ID="lblTipoModulo" runat="server" />
                        <asp:Label ID="lblHouse_Titulo" runat="server" /></h3>
                    ...
                    <asp:LinkButton ID="lkProximo" runat="server" BackColor="White" ForeColor="Black" Style="float: right; margin-top: -25PX; position: static;"
                        CssClass="btn btn-default"><i class="glyphicon glyphicon-step-forward"></i></asp:LinkButton>
                    <asp:LinkButton ID="lkAnterior" runat="server" BackColor="White" ForeColor="Black" Style="float: right; margin-top: -25PX; position: static;"
                        CssClass="btn btn-default"><i class="glyphicon glyphicon-step-backward"></i></asp:LinkButton>
                </div>
                                                    ...
                                                    <asp:GridView ID="dgvArquivosMaritimo" runat="server" AutoGenerateColumns="false" EmptyDataText="Nenhum arquivo enviado" DataKeyNames="ID_ARQUIVO" DataSourceID="dsUploadsMaritimo" CssClass="table table-hover table-sm grdViewTable" GridLines="None" CellSpacing="-1" Style="max-height: 400px; overflow: auto;" AllowSorting="true">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Enviar na S.I?" HeaderStyle-ForeColor="#337ab7">
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="ckEnvioSI" Checked='<%# Eval("FL_ENVIO_SI") %>' runat="server" AutoPostBack="true" OnCheckedChanged="ckEnvioSI_CheckedChanged" />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                <ItemTemplate>
                                    ...
                                    <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup" Style="display: none">
                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="False">
                                            ...
                                            <Triggers>
                                                ...
                                                <asp:AsyncPostBackTrigger ControlID="txtPesoVolumetrico_CargaAereo" />
                                                <asp:AsyncPostBackTrigger ControlID="txtPesoBruto_CargaAereo" />
