Public Class CadastrarEquipe_OLD
        ...
        Else
            If txtIDLider.Text = "" Then
                ...
                If ds.Tables(0).Rows(0).Item("QTD") = 0 Then
                    ...
                    Con.ExecutarQuery("INSERT INTO TB_INSIDE_LIDER (ID_USUARIO_LIDER,NM_EQUIPE) VALUES (" & ddlLider.SelectedValue & ",'" & txtNomeEquipe.Text & "')")
    ...
    Private Sub gdvLideres_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gdvLideres.RowCommand
        ...
        ElseIf e.CommandName = "Editar" Then
            ...
            Dim ds As DataSet = Con.ExecutarQuery("SELECT ID_USUARIO_LIDER,NM_EQUIPE FROM TB_INSIDE_LIDER WHERE ID = " & ID)
    ...
    Private Sub btnPesquisar_Click(sender As Object, e As EventArgs) Handles btnPesquisar.Click
        ...
        divErroMontarEquipe.Visible = False
        divSuccessMontarEquipe.Visible = False
        Dim sql As String = "select ID,ID_USUARIO,NOME,NM_EQUIPE from TB_USUARIO A INNER JOIN TB_INSIDE_LIDER B ON A.ID_USUARIO = B.ID_USUARIO_LIDER WHERE NOME LIKE '%" & txtPesquisa.Text & "%' ORDER BY NOME"
