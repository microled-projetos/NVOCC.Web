<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="MoedaFreteArmador.aspx.vb" Inherits="NVOCC.Web.MoedaFreteArmador" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="col-lg-6 col-lg-offset-3 col-md-12 col-sm-12">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">TAXA CÂMBIO PARCEIROS
                    </h3>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtIDMoedaFreteArmador" runat="server"  CssClass="form-control" Enabled="false"></asp:TextBox>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                  ...
                                  <div class="col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <asp:DropDownList ID="ddlArmador" runat="server" CssClass="form-control" Font-Size="11px" DataTextField="NM_RAZAO" DataSourceID="dsArmador" DataValueField="ID_PARCEIRO" >
                                       </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
         ...
         <div class="table-responsive"> 
                                <asp:GridView ID="dgvMoedaFrete" DataKeyNames="Id" DataSourceID="dsMoedaFrete"  CssClass="table table-hover table-sm grdViewTable" GridLines="None" CellSpacing="-1" runat="server" AutoGenerateColumns="false" style="max-height:400px; overflow:auto;" AllowSorting="true" OnSorting="dgvMoedaFrete_Sorting"   EmptyDataText="Nenhum registro encontrado.">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="NM_RAZAO" HeaderText="Armador" SortExpression="ID_ARMADOR" />
                                        ...
                                        <asp:TemplateField HeaderText="">
                                            <ItemTemplate>
                                                <a href="MoedaFreteArmador.aspx?id=<%# Eval("Id") %>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="Editar"><span class="glyphicon glyphicon-edit"  style="font-size:medium"></span></a>
                                            </ItemTemplate>
    ...
    <asp:SqlDataSource ID="dsMoedaFrete" runat="server" ConnectionString="<%$ ConnectionStrings:NVOCC %>"
        SelectCommand="SELECT A.ID_MOEDA_FRETE_ARMADOR as Id, C.NM_RAZAO, A.ID_ARMADOR,C.NM_RAZAO, A.ID_MOEDA, B.NM_MOEDA, A.DT_CAMBIO,A.VL_TXOFICIAL 
...
LEFT JOIN TB_PARCEIRO C ON C.ID_PARCEIRO = A.ID_ARMADOR" 
        DeleteCommand="DELETE FROM [dbo].[TB_MOEDA_FRETE_ARMADOR] WHERE ID_MOEDA_FRETE_ARMADOR = @Id">  
        <DeleteParameters>
