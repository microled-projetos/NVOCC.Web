            ...
            <asp:UpdatePanel ID="updPainel1" runat="server" UpdateMode="conditional" ChildrenAsTriggers="True">
                <ContentTemplate>
                    ...
                    <div runat="server" id="divAuxiliar" style="display: none">
                        ...
                        <asp:TextBox ID="txtStatusExpandir" runat="server" CssClass="form-control" Width="50PX"></asp:TextBox>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Scripts" runat="server">
    ...
    <script type="text/javascript">
        ...
        function divexpandcollapse(divname) {
            ...
            var txtStatusExpandir = document.getElementById('<%= txtStatusExpandir.ClientID %>').value;
          

            if (txtStatusExpandir == null || txtStatusExpandir == "") {
                txtStatusExpandir = "0"
            }

            if (txtStatusExpandir == "0") {
        ...
        function Expandir() {
            ...
            if (txtStatusExpandir == "0") {
                ...
                document.getElementById('<%= txtStatusExpandir.ClientID %>').value = '1';
            } else {

                document.getElementById('<%= txtStatusExpandir.ClientID %>').value = '0';
