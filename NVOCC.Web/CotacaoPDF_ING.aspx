...
<body style="margin: 0;">
    <form id="form" runat="server" style="font-family: Arial; font-size: 10px;">
        <div runat="server" class="interna" style="z-index: 2; position: absolute;">
                    ...
                    <tr>
                        ...
                        <td>
                            <p style="margin-left: 55px;">
                                ...
                                Issuance date:<asp:Label runat="server" ID="lblDataAtual" class="control-label" />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label runat="server" ID="Label2" class="control-label" /><br />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label runat="server" ID="Label3" class="control-label" /><br />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label runat="server" ID="Label4" class="control-label" /><br />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label runat="server" ID="Label5" class="control-label" />
                            </p>
            ...
            <strong>Via: </strong>
            <asp:Label runat="server" ID="lblVia" class="control-label" />
            <asp:Label runat="server" ID="lblEscalas" class="control-label" /><br />
            ...
            <div style="text-align: right; font-weight: bold">
                Sub Total:
                    <asp:Label runat="server" ID="lblTotalTaxasDestino" class="control-label" />
            </div>
