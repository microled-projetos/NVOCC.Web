...
<strong>Taxed Weight:</strong> <asp:label runat="server" ID="lblPesoTaxado" class="control-label" /><br />
<%--<strong>Cargo type:</strong> <asp:label runat="server" ID="lblTipoCarga" class="control-label" /><br />
...
<br /><div Visible="false" runat="server" style="text-align:right;font-weight:bold">Sub Total: <asp:label runat="server" ID="lblTotalFrete" class="control-label" /></div>
<div class="linha-colorida1">Origin charges</div>
<div id="divTaxaOrigem" style="font-family:Arial;font-size:10px;" runat="server">
</div> 
<br /><div style="text-align:right;font-weight:bold">Sub Total: <asp:label runat="server" ID="lblTotalTaxasOrigem" class="control-label" /></div>
...
<br /><div style="text-align:right;font-weight:bold">Sub Total: <asp:label runat="server" ID="lblTotalTaxasDestino" class="control-label" /></div>
...
<br/><br/><asp:label runat="server" ID="lblObsCliente" class="control-label" /> 
<br/><br/>  
