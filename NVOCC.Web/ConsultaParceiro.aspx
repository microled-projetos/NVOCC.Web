                         ...
                         <asp:Label ID="lblAtivo"  runat="server" Text='<%# Eval("Ativo") %>'/>
                                  ...
                                  CommandArgument='<%# Eval("Id") %>'><i class="fas fa-plus" style="font-size:medium"></i></asp:linkButton>
                                        ...
                                        <asp:TemplateField HeaderText="" >
                                         ...
                                         <asp:TemplateField HeaderText="">
                                            <ItemTemplate>
                                                 <asp:linkButton ID="btnDuplicar" title="Duplicar Parceiro" runat="server" CssClass="btn btn-primary btn-sm" CommandName="Duplicar" OnClientClick="javascript:return confirm('Deseja realmente duplicar este parceiro?');" 
