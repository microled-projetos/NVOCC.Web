Public Class Financeiro
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Con.Conectar()
        Dim ds As DataSet = Con.ExecutarQuery("SELECT FL_ACESSAR FROM [TB_GRUPO_PERMISSAO] where ID_Menu = 2027 AND  ID_TIPO_USUARIO = " & Session("ID_TIPO_USUARIO"))
    ...
    '        Dim Con As New Conexao_sql
    '        Con.Conectar()
    '        Dim ds As DataSet = Con.ExecutarQuery("SELECT FL_CADASTRAR FROM [TB_GRUPO_PERMISSAO] where ID_Menu = 2027 AND ID_TIPO_USUARIO = " & Session("ID_TIPO_USUARIO"))
    '        If ds.Tables(0).Rows.Count > 0 Then
    ...
    '        Dim Con As New Conexao_sql
    '        Con.Conectar()
    '        Dim ds As DataSet = Con.ExecutarQuery("SELECT FL_ATUALIZAR FROM [TB_GRUPO_PERMISSAO] where ID_Menu = 2027 AND ID_TIPO_USUARIO = " & Session("ID_TIPO_USUARIO"))
    '        If ds.Tables(0).Rows.Count > 0 Then
    ...
    '        Dim Con As New Conexao_sql
    '        Con.Conectar()
    '        Dim ds As DataSet = Con.ExecutarQuery("SELECT FL_EXCLUIR FROM [TB_GRUPO_PERMISSAO] WHERE ID_Menu = 2027 AND ID_TIPO_USUARIO =" & Session("ID_TIPO_USUARIO"))
    '        If ds.Tables(0).Rows.Count > 0 Then
