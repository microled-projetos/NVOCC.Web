...
WHERE ID_PARCEIRO =" & ID)
    ...
    Private Sub btnGravar_Click(sender As Object, e As EventArgs) Handles btnGravar.Click
        ...
        ElseIf (ckbImportador.Checked = True Or ckbExportador.Checked = True Or ckbAgente.Checked = True Or ckbComissaria.Checked = True Or ckbAgenteInternacional.Checked = True Or ckbIndicador.Checked = True Or ckbShipper.Checked = True Or ckbCNEE.Checked = True) And ddlTipoFaturamento.SelectedValue = 0 Then
