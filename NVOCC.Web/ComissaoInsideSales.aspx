                            ...
                            <ContentTemplate>
                                ...
                                <div runat="server" visible="false" id="DivGrid2">
                                    <div class="table-responsive tableFixHead DivGrid" id="DivGrid">
                                        <asp:GridView ID="dgvComissoes" DataKeyNames="ID_DETALHE_COMISSAO_INSIDE,ID_CABECALHO_COMISSAO_INSIDE" DataSourceID="dsComissao" CssClass="table table-hover table-sm grdViewTable" GridLines="None" CellSpacing="-1" runat="server" AutoGenerateColumns="false" Style="max-height: 400px; overflow: auto;" AllowSorting="true" EmptyDataText="Nenhum registro encontrado.">
                                            <Columns>
                                                <asp:TemplateField HeaderText="ID" Visible="False">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("ID_DETALHE_COMISSAO_INSIDE") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:BoundField DataField="NM_EQUIPE" HeaderText="EQUIPE LÍDER" SortExpression="NM_EQUIPE" />
                                                <asp:BoundField DataField="NM_TIME" HeaderText="TIME" SortExpression="NM_TIME" />
                                                ...
                                                <asp:TemplateField HeaderText="">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="btnSelecionar" runat="server" CssClass="btn btn-primary btn-sm"
                                                            CommandArgument='<%# Eval("ID_DETALHE_COMISSAO_INSIDE") & "|" & Container.DataItemIndex %>' CommandName="Selecionar" Text="Selecionar" OnClientClick="SalvaPosicao()"></asp:LinkButton>
                                                    </ItemTemplate>
...
<asp:LinkButton ID="lkGerarComissao" runat="server" CssClass="btn btnn btn-default btn-sm btn-block" Style="font-size: 15px" >Gerar Comissões</asp:LinkButton>
                               ...
                               <div class="modal-footer">
                                ...
                                <asp:Panel ID="pnlRelatorios" runat="server" CssClass="modalPopup" Style="display: none;">
                                    <center>     <div class=" modal-dialog modal-dialog-centered modal-sm" role="document">
                                     ...
                                     <div class="col-sm-10">
                                    <div class="form-group">                                             
                                           <asp:LinkButton ID="lkCSV" runat="server" CssClass="btn btnn btn-default btn-sm btn-block" Style="font-size: 15px">Exportar CSV</asp:LinkButton>
                                        </div>
                                         </div>
                                   </div> 
                                                            <div class="row">
                               ...
                               <asp:TextBox ID="txtLCL"  runat="server" CssClass="form-control valores"></asp:TextBox>
                                        </div>
                                         </div>
                                     <div class="col-sm-3">
                                    <div class="form-group">                                          
 <asp:Label ID="Label8" runat="server">Taxa FCL</asp:Label><br />
                               ...
                               <asp:TextBox ID="txtFCL"  runat="server" CssClass="form-control valores"></asp:TextBox>
 ...
 <asp:DropDownList ID="ddlGestor" runat="server" CssClass="combos form-control" DataTextField="NOME" DataSourceID="dsGestor" DataValueField="ID_USUARIO" style="font-size:15px; width: 300px !important" AutoPostBack="true" ></asp:DropDownList>                                    
                                        </div>
                                         </div>
                                       <div class="col-sm-5">
                                    <div class="form-group">                                          
...
<asp:Label ID="Label34" runat="server">Data Liquidação</asp:Label><label runat="server" style="color: red">*</label><br />
                            ...
                            <Triggers>
                                ...
                                <asp:PostBackTrigger ControlID="lkResumoRelatório" />
                            </Triggers>
                        </asp:UpdatePanel>
                    </div>
