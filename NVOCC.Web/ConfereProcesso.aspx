<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConfereProcesso.aspx.cs" Inherits="ABAINFRA.Web.ConfereProcesso" %>
                                ...
                                <div class="row flexdiv topMarg" style="padding: 0 15px">
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label class="control-label">Data Chegada Inicial:</label>
                                            <input id="txtDtInicialChegada" class="form-control" type="date" required="required"/>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label class="control-label">Data Chegada Final:</label>
                                            <input id="txtDtFinalChegada" class="form-control" type="date" required="required"/>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-group">
...
<asp:Content ID="Content2" ContentPlaceHolderID="Scripts" runat="server">
    ...
    <script>
        ...
        function Saldo() {
            var dtInicial = document.getElementById("txtDtInicialChegada").value;
            var dtFinal = document.getElementById("txtDtFinalChegada").value;
            ...
            var filter = document.getElementById("ddlFilterSaldo").value;
                $.ajax({
                    ...
                    data: '{nota: "' + nota + '", filter: "' + filter + '", dataI: "' + dtInicial + '", dataF: "' + dtFinal+'"}',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    beforeSend: function () {
                        $("#grdSaldoBody").empty();
