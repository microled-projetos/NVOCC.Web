...
WHERE DT_IMPORTACAO IS NULL  AND A.ID_COTACAO = @ID_COTACAO  AND ISNULL(VL_TAXA_VENDA,0) <> 0 AND ID_COTACAO_TAXA NOT IN (SELECT ISNULL(ID_COTACAO_TAXA,0) FROM View_Taxa_Bloqueada WHERE CD_PR= 'R')
"><SelectParameters>
            <asp:ControlParameter Name="ID_COTACAO" Type="Int32" ControlID="txtID" />
        </SelectParameters>
    </asp:SqlDataSource>
