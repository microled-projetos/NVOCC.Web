                   ...
                   <div class="row linhabotao text-center" style="margin-left: 0px; border: ridge 1px; padding-top: 20px; padding-bottom: 20px; margin-right: 5px;">
                      ...
                      <div class="col-sm-1" >
                           <div class="form-group">                           <asp:Label ID="Label1" runat="server">Competencia</asp:Label><br />
                               ...
                               <asp:TextBox ID="TextBox2" placeholder="__/__/____" runat="server" CssClass="form-control data"></asp:TextBox><br/>
                               <asp:CheckBox ID="ckbAtivo" runat="server" CssClass="form-control" Text="&nbsp;&nbsp;Quinzena" />
                       ...
                       <div class="col-sm-offset-1 col-sm-5">
                           <asp:Label ID="Label6" Style="padding-left: 35px" runat="server">Ações</asp:Label><br />
                                                      <asp:LinkButton ID="lkRelatorios" runat="server" CssClass="btn btnn btn-default btn-sm" Style="font-size: 15px">Tabela Comissões</asp:LinkButton>
                           ...
                           <asp:LinkButton ID="lkGravarCCProcesso" runat="server" CssClass="btn btnn btn-default btn-sm" Style="font-size: 15px">Gravar no Conta Corrente do Processo</asp:LinkButton>
                                ...
                                <div class="table-responsive tableFixHead DivGrid" id="DivGrid">
                                    <asp:GridView ID="dgvComissoes" DataKeyNames="ID_CABECALHO_COMISSAO_VENDEDOR" DataSourceID="dsComissao" CssClass="table table-hover table-sm grdViewTable" GridLines="None" CellSpacing="-1" runat="server" AutoGenerateColumns="false" Style="max-height: 400px; overflow: auto;" AllowSorting="true" EmptyDataText="Nenhum registro encontrado.">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="NR_NOTA_FISCAL" HeaderText="NOTA_FISCAL" SortExpression="NR_NOTA_FISCAL" />
                                ...
                                <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender4" runat="server" PopupControlID="pnlDesmosntrativos" TargetControlID="lkComissoes" CancelControlID="btnFecharDesmosntrativos"></ajaxToolkit:ModalPopupExtender>
...
<asp:LinkButton ID="lkNotaDebito" runat="server" CssClass="btn btnn btn-default btn-sm btn-block" Style="font-size: 15px"  href="#" OnClientClick="ImprimirND()" >Gerar Comissões</asp:LinkButton>
                                    </div>
                                        </div>
                                         </div>
                                    <div class="row">
                                     <div class="col-sm-10">
                                    <div class="form-group">                                             
                                                                                <asp:LinkButton ID="lkReciboServico" runat="server" CssClass="btn btnn btn-default btn-sm btn-block" Style="font-size: 15px">Ajustar Comissões</asp:LinkButton>
                                        </div>
                                         </div>
                                   </div>          
                                </div>  
                               ...
                               <div class="modal-footer">
                                ...
                                <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender2" runat="server" PopupControlID="pnlNotasFiscais" TargetControlID="lkRelatorios" CancelControlID="btnFecharNotas"></ajaxToolkit:ModalPopupExtender>
...
<asp:LinkButton ID="lkCancelarNota" runat="server" CssClass="btn btnn btn-default btn-sm btn-block" Style="font-size: 15px" OnClientClick="return confirm( getProcesso() + '\n'+ getCliente() + '\n\n\n\CONFIRMAR CANCELAMENTO DA NOTA FISCAL');" >Por Vendedor</asp:LinkButton>
                                    ...
                                    <div class="row">
                                     <div class="col-sm-10">
                                    <div class="form-group">                                             
                                                                                <asp:LinkButton ID="lkSubstituirNota" runat="server" CssClass="btn btnn btn-default btn-sm btn-block" Style="font-size: 15px">Com Disparo de Email</asp:LinkButton>
                                        </div>
                                         </div>
                                   </div>      
    ...
    <asp:SqlDataSource ID="dsComissao" runat="server" ConnectionString="<%$ ConnectionStrings:NVOCC %>"
        SelectCommand="SELECT A.ID_CABECALHO_COMISSAO_VENDEDOR,DT_COMPETENCIA,NR_PROCESSO,NR_NOTAS_FISCAL,DT_NOTA_FISCAL,
(SELECT NM_RAZAO FROM TB_PARCEIRO WHERE ID_PARCEIRO = ID_PARCEIRO_VENDEDOR) PARCEIRO_VENDEDOR,
(SELECT NM_RAZAO FROM TB_PARCEIRO WHERE ID_PARCEIRO = ID_PARCEIRO_CLIENTE)PARCEIRO_CLIENTE,
(SELECT NM_TIPO_ESTUFAGEM FROM TB_TIPO_ESTUFAGEM WHERE ID_TIPO_ESTUFAGEM = ID_TIPO_ESTUFAGEM)TIPO_ESTUFAGEM,QT_BL,QT_CNTR, VL_COMISSAO_BASE,VL_PERCENTUAL,VL_COMISSAO_TOTAL,DT_LIQUIDACAO,DS_OBSERVACAO 
FROM TB_CABECALHO_COMISSAO_VENDEDOR A
LEFT JOIN TB_DETALHE_COMISSAO_VENDEDOR B ON B.ID_CABECALHO_COMISSAO_VENDEDOR = A.ID_CABECALHO_COMISSAO_VENDEDOR"></asp:SqlDataSource>
</asp:Content>
