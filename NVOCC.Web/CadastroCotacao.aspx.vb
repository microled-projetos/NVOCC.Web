...
FROM TB_COTACAO_TAXA WHERE VL_TAXA_VENDA IS NOT NULL AND VL_TAXA_VENDA <> 0 AND  ID_COTACAO = " & txtID.Text)
 ...
 WHERE ID_COTACAO =  " & txtID.Text)
        ...
        ElseIf ddlEstufagem.SelectedValue = 2 Then
            ...
            Con.ExecutarQuery("INSERT INTO TB_CARGA_BL (QT_MERCADORIA,VL_PESO_BRUTO,VL_M3,VL_ALTURA,VL_LARGURA,VL_COMPRIMENTO,ID_BL) 
SELECT SUM(QT_MERCADORIA)QT_MERCADORIA,SUM(VL_PESO_BRUTO)VL_PESO_BRUTO,SUM(VL_M3)VL_M3,SUM(VL_ALTURA)VL_ALTURA,SUM(VL_LARGURA)VL_LARGURA,SUM(VL_COMPRIMENTO)VL_COMPRIMENTO," & ID_BL & " FROM TB_COTACAO_MERCADORIA
 WHERE ID_COTACAO =  " & txtID.Text)
