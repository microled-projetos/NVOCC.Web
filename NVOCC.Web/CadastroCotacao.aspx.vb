...
CONVERT(varchar,A.DT_ABERTURA,103)DT_ABERTURA,FL_FREE_HAND,ID_STATUS_FRETE_AGENTE,ID_PARCEIRO_EXPORTADOR,ISNULL(A.ID_PARCEIRO_IMPORTADOR,0)ID_PARCEIRO_IMPORTADOR,
A.ID_STATUS_COTACAO,
...
(SELECT (SELECT QT_DIAS_FREETIME FROM TB_TARIFARIO_FRETE_TRANSPORTADOR T WHETE T.ID_FRETE_TRANSPORTADOR =  " & ddlFreteTransportador_Frete.SelectedValue & " AND T.ID_TIPO_CONTAINER = M.ID_TIPO_CONTAINER ) FROM TB_COTACAO_MERCADORIA M WHERE M.ID_COTACAO_MERCADORIA = " & linha.Item("ID_COTACAO_MERCADORIA") & " )
                                   THEN 
