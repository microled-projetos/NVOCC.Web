    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            If Request.QueryString("id") <> "" Then
                ...
                ds = Con.ExecutarQuery("SELECT F.NR_NOTA_DEBITO,CONVERT(VARCHAR,F.DT_NOTA_DEBITO,103)DT_NOTA_DEBITO,F.ID_FATURAMENTO,A.ID_CONTA_PAGAR_RECEBER,C.ID_PARCEIRO_EMPRESA,CONVERT(VARCHAR,A.DT_VENCIMENTO,103)DT_VENCIMENTO,NR_FATURA_FORNECEDOR,
