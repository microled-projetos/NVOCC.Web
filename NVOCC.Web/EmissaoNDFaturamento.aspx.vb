...
(SELECT SIGLA_MOEDA FROM TB_MOEDA WHERE ID_MOEDA = (SELECT ID_MOEDA FROM TB_BL_TAXA WHERE ID_BL_TAXA = A.ID_BL_TAXA))MOEDA,VL_TAXA_CALCULADO,VL_CAMBIO,ISNULL(VL_LANCAMENTO,0)VALORES,VL_ISS
