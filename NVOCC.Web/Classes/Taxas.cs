...
namespace ABAINFRA.Web
{
    public class Taxas
    {
        ...
        private int id_porto_recebimento;
        private int id_porto_carregamento;
        private string id_porto_descarga;
        private int id_aeroporto_carregamento;
        private int id_aeroporto_descarga;
        ...
        public int ID_PORTO_RECEBIMENTO { get => id_porto_recebimento; set => id_porto_recebimento = value; }
        public int ID_PORTO_CARREGAMENTO { get => id_porto_carregamento; set => id_porto_carregamento = value; }
        public string ID_PORTO_DESCARGA { get => id_porto_descarga; set => id_porto_descarga = value; }
        public int ID_AEROPORTO_CARREGAMENTO { get => id_aeroporto_carregamento; set => id_aeroporto_carregamento = value; }
        public int ID_AEROPORTO_DESCARGA { get => id_aeroporto_descarga; set => id_aeroporto_descarga = value; }
