                                   ...
                                   <div class="row">
                                    ...
                                    <div class="form-group"><div class="table-responsive tableFixHead">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="DT_RECEBIMENTO" HeaderText="DATA RECEBIMENTO" SortExpression="DT_RECEBIMENTO" />                   <asp:TemplateField HeaderText="ID_ITEM_DESPESA" SortExpression="ID_ITEM_DESPESA" Visible="false">
                                                    <ItemTemplate>
