Public Class EmissaoND
    ...
    Private Sub dgvNotas_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles dgvNotas.RowCommand
        ...
        If e.CommandName = "Selecionar" Then
            ...
            Dim ds As DataSet = Con.ExecutarQuery("SELECT A.ID_CONTA_PAGAR_RECEBER,ID_PARCEIRO_EMPRESA,CONVERT(VARCHAR,DT_VENCIMENTO,103)DT_VENCIMENTO,NR_FATURA_FORNECEDOR,
...
GROUP BY A.ID_CONTA_PAGAR_RECEBER,ID_PARCEIRO_EMPRESA,DT_VENCIMENTO,NR_FATURA_FORNECEDOR,ID_PORTO_ORIGEM,ID_PORTO_DESTINO,DT_EMBARQUE,DT_CHEGADA,ID_NAVIO,NR_BL, VL_PESO_BRUTO,VL_M3,QT_MERCADORIA,D.ID_BL")
