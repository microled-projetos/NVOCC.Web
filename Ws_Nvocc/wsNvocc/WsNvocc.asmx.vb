...
saida:
    ...
    <WebMethod()>
    Public Function DesBloqueio(ByVal Bl As String, ByVal Acao As String, ByVal MotivoBloqueio As String, ByVal MotivoLiberacao As String, usuario As String) As String
        Dim Sql As String
