...
FROM [TB_GRUPO_PERMISSAO] where ID_Menu = 17 AND ID_TIPO_USUARIO IN( SELECT distinct ID_TIPO_USUARIO from TB_VINCULO_USUARIO where ID_USUARIO = " & Conversions.ToString(UsuarioSistema) & ")  ")
